...
POLYGON_API_KEY = "YOUR_POLYGON_API_KEY_HERE"  # Replace with your actual API key from https://polygon.io/

# Data Cache Settings
DATA_CACHE = {
    "cache_directory": None,  # None = use default 'data_cache' folder within polygonDataPipeline
    "auto_cleanup": False,    # Automatically cleanup old cache files
    "max_cache_size_gb": 0.5  # Maximum cache size in GB before cleanup
}
